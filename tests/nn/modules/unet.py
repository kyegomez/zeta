...
import pytest
import torch
from zeta.nn.modules.unet import Unet  # Adjust this import according to your project structure
...
@pytest.mark.parametrize("n_channels, n_classes, expected_shape", [
    (1, 2, (1, 2, 388, 388)),
    (3, 4, (1, 4, 388, 388)),
    (5, 6, (1, 6, 388, 388)),
])
def test_unet_output_shape_with_parametrization(n_channels, n_classes, expected_shape, input_tensor):
    model = Unet(n_channels, n_classes)
    output = model(input_tensor)
