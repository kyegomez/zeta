import torch
import pytest
from zeta.nn.modules.visual_expert import VisualExpert  # Import the VisualExpert class from your module
...
def test_visual_expert_attention_and_feedforward(visual_expert_instance):
    assert isinstance(visual_expert_instance.attention, torch.nn.modules.MultiheadAttention)
