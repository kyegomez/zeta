...
@pytest.mark.parametrize("input_tensor", [torch.randn(128, in_features), torch.randn(1, in_features)])
...
def test_forward_pass_calculation(qlora_layer):
    ...
    lora_output = (input_tensor @ qlora_layer.lora_A.transpose(0, 1)) @ qlora_layer.lora_B.transpose(0, 1)
