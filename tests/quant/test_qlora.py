...
@pytest.fixture
def qlora_layer():
    return QloraLinear(in_features, out_features, weight, r, lora_alpha,
                       lora_dropout)
...
def test_forward_pass_calculation(qlora_layer):
    ...
    lora_output = (input_tensor @ qlora_layer.lora_A.transpose(
        0, 1)) @ qlora_layer.lora_B.transpose(0, 1)
